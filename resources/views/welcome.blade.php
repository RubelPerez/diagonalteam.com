                ...
                <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link text-white display-4" data-target-id="team1-k" href="#team1-k"><span class="socicon socicon-teamspeak mbr-iconfont mbr-iconfont-btn"></span>
                                    Equipo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link text-white display-4" data-target-id= "counters6-i" href="#counters6-i"><span class="socicon socicon-storehouse mbr-iconfont mbr-iconfont-btn"></span>
                                    Nosotros</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link text-white display-4" data-target-id= "clients-j" href="#clients-j"><span class="mbri-users  mbr-iconfont mbr-iconfont-btn"></span>
                                    Nuestros Clientes</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <form action="https://mobirise.com/" method="POST" id="Formulario" class="mbr-form form-with-styler" data-form-title="Mobirise Form">
                                ...
                                <div class="dragArea row">
                                    ...
                                    <div data-for="phone" class="col-md-6  form-group">
                                        <label for="phone-form1-l" class="form-control-label mbr-fonts-style display-7">Telefono</label>
                                        <input type="tel" name="phone" data-form-field="Phone" class="form-control display-7" id="phone-form1-l">
                                    </div>
                                    <div class="col-md-12  form-group" data-for="email">
                                        <label for="email-form1-l" class="form-control-label mbr-fonts-style display-7">Correo</label>
